...
module.exports = {
  ...
  factories: {
    ...
    StandardRefundCampaignFactory: contractFactoryFunction(JSON.parse(classes_module.StandardCampaignFactory.interface)),
    StandardCampaignFactory: contractFactoryFunction(JSON.parse(classes_module.StandardCampaignFactory.interface)),
  },
